...
*Mirror of the [Notion page](https://app.notion.com/p/3a99073ab18781cc802cd951541d72b4). Part of [SDR Onboarding](./README.md). Replaces the old `lead-source-playbook.md`.*
...
|---|---|---|
| **Site visitors** | Firms already looking at us | Week 5 |
| **Partnership installed base** | Firms already running the systems we plug into | Week 6 |
| **Case-study geography** | Firms near a reference we can name | Week 7 |

Everything after week 8 is running all three at once and deciding for yourself where the hours go.

---

## Engine one · Site visitors
...
| What they read | What is probably going on | What you open with |
|---|---|---|
| Pricing, more than once | Somebody is building a case internally | The economics, and who else at their size bought |
| A specific practice area page | A practice group leader has a problem this quarter | That practice, that workflow, nothing else |
| A case study | They are looking for proof from a firm like them | The nearest reference, and an offer to introduce |
| Security or trust pages | There is a sceptic, often a CIO or a risk partner | Security first, product second |
| Careers or about | Probably not a buyer | Leave it |
...
## Engine two · The partnership installed base
...
Do this once properly and you have a repeatable machine. Build a table, keep it current, and share it. The list should outlive any single campaign.
...
| Region | Anchor | Who you go after next |
|---|---|---|
| UK North West | Harrison Drury | Ten to fifty lawyer full-service firms across the region |
| Australia | Hicksons | Sydney and Melbourne mid-market, insurance and commercial |
| Brazil | Lobo de Rizzo | São Paulo corporate and disputes boutiques |
| India | ELP | Mumbai and Delhi commercial firms |
...
**Events and conferences.** Lists come back from these and they rot fast. Whoever attended owes you a debrief. Get it within a week.
